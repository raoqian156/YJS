...
//            }
    ...
    private final class MyBilder extends GuardAidl2.Stub {
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            if (ServiceUtils.isServiceRunning(getApplicationContext(), "io.dcloud.uniplugin.keep.LocalService")) {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                if (mBilder != null && KeepLive.foregroundNotification != null) {
                    GuardAidl2 guardAidl = GuardAidl2.Stub.asInterface(service);
