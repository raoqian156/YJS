...
public class FragmentSaveTabHost<C extends BaseFragment> extends TabHost implements
  ...
  private void initFragmentTabHost(Context context, AttributeSet attrs) {
    final TypedArray a = context
        .obtainStyledAttributes(attrs, new int[]{android.R.attr.inflatedId}, 0, 0);
  ...
  public void addTab(@NonNull TabSpec tabSpec, Class<? extends BaseFragment> controller,
    ...
    if (mLastTab != newTab) {
      ...
      if (newTab != null) {
        if (newTab.fragment == null) {
            try {
                newTab.fragment = newTab._class.newInstance();
  ...
  static final class FragmentTabInfo {
    ...
    String tag;
    final @NonNull
    Class<? extends BaseFragment> _class;
    final @Nullable
    Bundle args;
    Fragment fragment;

    FragmentTabInfo(@NonNull String _tag, Class<? extends BaseFragment> _class,
                    @Nullable Bundle _args) {
      this.tag = _tag;
      this._class = _class;
      this.args = _args;
    }
  ...
  static class SavedState extends BaseSavedState {
    ...
    public String toString() {
      return "FragmentTabHost.SavedState{" + Integer
          .toHexString(System.identityHashCode(this)) + " curTab=" + curTab + "}";
    }
  }
}
